    ...
    process {
        ...
        try {
            ...
            foreach ($Software in $latestSoftware) {
                ...
                Copy-Item -Path "\\Server\Path\Here\FireFox\Settings\AutoConfig.js" -Destination "C:\Program Files\Mozilla Firefox\defaults\pref"
                Copy-Item -Path "\\Server\Path\Here\FireFox\Settings\Somebusiness.cfg" -Destination "C:\Program Files\Mozilla Firefox"
                #######################################
...
Install-FireFox -Path "\\Server\Path\Here\Settings\JSON\Applications.json"