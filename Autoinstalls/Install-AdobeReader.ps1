function Install-AdobeReader {
    ...
    param (
        ...
        [String]$Name = "Adobe Acrobat Reader DC",

        [Parameter(Mandatory = $false, ValueFromPipeline = $true)]
        [String]$Process = "AcroRd32",
        ...
        [Parameter(Mandatory = $false,
            ...
            ValueFromPipelineByPropertyName = $true)]
        [ValidateNotNullOrEmpty()]
        [string]$LogPath = "C:\Temp\AdobeAcrobatReaderDC",
...
Install-AdobeReader -Path "\\Server\Path\Here\Settings\JSON\Applications.json"