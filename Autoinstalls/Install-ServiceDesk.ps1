function Install-ServiceDesk {
    ...
    param (
        ...
        [Parameter(Mandatory = $false,
            ...
            ValueFromPipelineByPropertyName = $true)]
        [ValidateNotNullOrEmpty()]
        [string]$LogPath = "C:\Temp\ServiceDesk",
...
Install-ServiceDesk -Path "\\Server\Path\Here\Settings\JSON\Applications.json"